...
def generate_launch_description():
    ...
    use_lidar    = LaunchConfiguration('use_lidar', default='false')  # Make LIDAR optional
    ...
    return LaunchDescription([
        ...
        # LIDAR node (disabled by default in simulation)
        Node(
            ...
            output='screen',
            condition=IfCondition(use_lidar)  # Only launch if use_lidar is true
        ),

        # Only launch RealSense launch file if not in simulation
        IncludeLaunchDescription(
            ...
            condition=UnlessCondition(use_sim_time)  # Only launch if not in simulation
        ),
